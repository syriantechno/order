...
if (!$account = get_account($user->account_id)) {
    add_console_log('Kullanıcıya ait hesap karti bulunamadı.', __FUNCTION__);
}
?>
...
<div class="print-page" size="A4">
    ...
    <div class="print-footer print-footer-right text-center">
        <small class="text-muted">Bu belge <?php echo get_active_user('display_name'); ?>
            بواسطة, <?php echo til_get_date(true, 'datetime'); ?> tarihinde oluşturuldu.
        </small>
        <br/>
    </div>
