        ...
        <form name="form_status" id="form_status"
            ...
            <div class="bank_detail bg-info padding-5 margin-bottom-15">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="bank_admin_name" id="bank_admin_name" class="form-control" minlength="3"
                           maxlength="32">
                </div> <!-- /.form-group -->
                ...
                <div class="row space-5">
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="branch_code" id="branch_code" class="form-control" minlength="3"
                                   maxlength="32">
                        </div> <!-- /.form-group -->
                    </div> <!-- /.col-md-3 -->
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="account_no" id="account_no" class="form-control" minlength="3"
                                   maxlength="32">
                        </div> <!-- /.form-group -->
                    </div> <!-- /.col-md-3 -->
                    <div class="col-md-6">
                ...
                <?php if ($cases): ?>
                    <table class="table table-hover table-condensed">
                        ...
                        <?php foreach ($cases as $case): $case->total = calc_case($case->id); ?>
                            <tr>
                                <td>
                                    <a href="?detail&status_id=<?php echo $case->id; ?>"><span><?php echo $case->name; ?></span></a> <?php if ($case->is_default == 'default'): ?>
                                        <small class="text-muted">(الافتراضي)</small><?php endif; ?></td>
                ...
                <?php if ($banks): ?>
                    <table class="table table-hover table-condensed">
                        ...
                        <?php foreach ($banks as $bank): $bank->total = calc_case($bank->id); ?>
                            <tr>
                                <td>
                                    <a href="?detail&status_id=<?php echo $bank->id; ?>"><span><?php echo $bank->name; ?></span></a> <?php if ($bank->is_default == 'default'): ?>
                                        <small class="text-muted">(الافتراضي)</small><?php endif; ?></td>
