...
if (isset($_POST['add'])) {
    ...
    if ($_color) {
        @form_validation($_POST['status_color'], 'status_color', 'Renk kodu', 'required|min_length[3]|max_length[64]', 'input_control_');
    }
    ...
    if (!is_alert('input_control_')) {
        ...
        if ($_color) {
            $args['insert']['color'] = $_POST['status_color'];
        }
        if ($_bg_color) {
            $args['insert']['bg_color'] = $_POST['status_bg_color'];
        }
        if ($_sms_template) {
            $args['insert']['sms_template'] = $_POST['sms_template'];
        }
        if ($_email_template) {
            $args['insert']['email_template'] = $_POST['email_template'];
        }
        ...
        if (isset($_POST['auto_sms'])) {
            $args['insert']['auto_sms'] = 'auto_sms';
        } else {
            $args['insert']['auto_sms'] = '';
        }
        if (isset($_POST['auto_email'])) {
            $args['insert']['auto_email'] = 'auto_email';
        } else {
            $args['insert']['auto_email'] = '';
        }

        if (add_form_status($args)) {
            _set_form_status_default($_taxonomy);
        }
    }
}
    ...
    <div class="col-lg-4 col-md-6">
        <form name="form_status" id="form_status"
            ...
            <div class="form-group">
                ...
                <input type="text" name="status_name" id="status_name" class="form-control required" minlength="3"
                       maxlength="20">
            </div> <!-- /.form-group -->
            ...
            <?php if ($_bg_color or $_color): ?>
                <div class="form-group text-center">
                    <span class="label label-success label-fs-example long"
                          style="background-color:#fdc430; color:#000000;">معاينة</span>
                    |
                    <span class="label label-success label-fs-example abbreviation"
                          style="background-color:#fdc430; color:#000000;">OD</span>
                </div> <!-- /.form-group -->
                <script>
            ...
            <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="status_bg_color"><i class="fa fa-square color-bg-status"
                                                            style="color:#fdc430;"></i> كود لون الخلفية</label>
                            <input type="text" name="status_bg_color" id="status_bg_color"
                                   class="form-control required colorpicker_bg_status" maxlength="32" value="#fdc430">
                            <script>
                                $(document).ready(function () {
                ...
                <?php if ($_color): ?>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="status_color"><i class="fa fa-square color-status" style="color:#000;"></i> كود
                                لون النص</label>
                            <input type="text" name="status_color" id="status_color"
                                   class="form-control required colorpicker_status" maxlength="32" value="#000">
                            <script>
                                $(document).ready(function () {
            ...
            <?php if ($_sms_template): ?>
                <div class="form-group">
                    <label for="sms_template">قالب رسالة نصية
                        <small><span id="sms_count">0</span> حرف</small>
                    </label>
                    <label class="veritical-center pull-right">
                        <small class="text-muted">هل تريد ارسال رسالة نصية تلقائية</small> &nbsp; <input type="checkbox"
                                                                                                         name="auto_sms"
                                                                                                         id="auto_sms"
                                                                                                         value="true"
                                                                                                         class="toogle"
            ...
            <?php if ($_email_template): ?>
                <div class="form-group">
                    ...
                    <label class="veritical-center pull-right">
                        <small class="text-muted">هل تريد ارسال بريد الكتروني تلقائي</small> &nbsp; <input
                                type="checkbox" name="auto_email" id="auto_email" value="true" class="toogle"
                                data-size="mini" data-on-text="نعم" data-off-text="لا"></label>
                    <textarea name="email_template" id="email_template" class="form-control"
