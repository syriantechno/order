...
<?php if ($cases or $banks): // kasa veya banka var mi? ?>
    ...
    if (isset($_GET['account_id'])) {
        if ($account = get_account($_GET['account_id'])) {
            ...
            add_alert('Hesap kartı bulunamadı.', 'warning');
        }
    }
    ?>
    ...
    <ul class="nav nav-tabs" role="tablist">
        <li role="presentation" class="active"><a href="#home" id="home-tab" role="tab" data-toggle="tab"
                        ...
                        class="fa fa-file-text-o"></i> النموذج</a></li>
        <?php if ($payment->id): ?>
            <li role="presentation" class="dropdown pull-right"><a href="#" class="dropdown-toggle" id="myTabDrop1"
                    ...
                    خيارات <span class="caret"></span></a>
                <ul class="dropdown-menu" aria-labelledby="myTabDrop1" id="myTabDrop1-contents">
                    <li><a href="#dropdown1" role="tab" id="dropdown1-tab" data-toggle="tab"
                           aria-controls="dropdown1"><i class="fa fa-tasks fa-fw"></i> تعيين المهمة</a></li>
                    <li>
                        <a href="<?php site_url('admin/user/message/add.php?attachment&payment_id=' . $payment->id); ?>"><i
                                    class="fa fa-envelope-o fa-fw"></i> إضافة مرفق الرسالة</a></li>
            ...
            <?php if ($payment->id): ?>
                <li class="pull-right"><a href="print.php?id=<?php echo $payment->id; ?>&print" target="_blank"><i
                            class="fa fa-print"></i> طباعة</a></li><?php endif; ?>
        <?php endif; ?>
    </ul>
    ...
    <div class="tab-content">
        <div class="tab-pane fade active in" role="tabpanel" id="home" aria-labelledby="home-tab">
            ...
            <form name="form_payment" id="form_payment" action="" method="POST">
                ...
                <div class="row">
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <input type="text" name="date" id="date"
                                   value="<?php echo @substr($payment->date, 0, 16); ?>"
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <input type="text" name="account_code" id="account_code"
                                   value="<?php echo @$payment->account_code; ?>" class="form-control input-sm focus"
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            <label for="account_name">اسم الموظفين اسم العائلة <?php if (@$payment->account_id): ?><a
                                    href="../account/detail.php?id=<?php echo $payment->account_id; ?>" target="_blank">
                                        <i class="fa fa-external-link"></i></a><?php endif; ?> </label>

                            <!-- yeni hesap karti olusturulsun mu? -->
                            <label id="new_account" class="pull-right" data-toggle="tooltip" data-placement="top"
                                   title="" data-original-title="Yeni bir hesap kartı oluşturulsun mu?"><input
                                        type="checkbox" name="new_account" id="new_account" value="true" class="toogle"
                                        data-size="extramini" data-on-text="Evet" data-off-text="Hayır"
                                        tabindex="-1"></label>
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <input type="text" name="account_tax_no" id="account_tax_no"
                                   value="<?php echo @$payment->account_tax_no; ?>" class="form-control input-sm"
                                   minlength="3" maxlength="32">
                        </div> <!-- /.form-group -->
                    </div> <!-- /.col-md-2 -->
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <input type="text" name="account_gsm" id="account_gsm"
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <input type="text" name="account_email" id="account_email"
                                   value="<?php echo @$payment->account_email; ?>" class="form-control input-sm email">
                        </div> <!-- /.form-group -->
                    </div> <!-- /.col-md-3 -->
                </div> <!-- /.row -->
        ...
        <div class="tab-pane fade" role="tabpanel" id="profile" aria-labelledby="profile-tab">
            <p>Food <a href="#" onclick="getJSON_click();">truck</a> fixie locavore, accusamus mcsweeney's marfa nulla
                single-origin coffee squid. Exercitation +1 labore velit, blog sartorial PBR leggings next level wes
                anderson artisan four loko farm-to-table craft beer twee. Qui photo booth letterpress, commodo enim
                craft beer mlkshk aliquip jean shorts ullamco ad vinyl cillum PBR. Homo nostrud organic, assumenda
                labore aesthetic magna delectus mollit. Keytar helvetica VHS salvia yr, vero magna velit sapiente labore
                stumptown. Vegan fanny pack odio cillum wes anderson 8-bit, sustainable jean shorts beard ut DIY ethical
